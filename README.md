# AInews v2.0.0 - 智能新闻处理系统

> 🎉 **最新版本**: v2.0.0 - Phoenix 独立系统升级  
> 📅 **发布日期**: 2025年7月30日  
> 🚀 **主要更新**: Phoenix 独立系统、北京时间支持、高级评分算法

## 🎯 系统概述

AInews v2.0.0 是一个基于 EventRegistry 的智能新闻处理系统，集成了独立的 Phoenix 新闻处理管道。系统通过聚类、打分和自动调参，实现高质量的新闻事件去同质化，为零 GPT 依赖的新闻汇总提供数据基础。

### v2.0 新特性
- **Phoenix 独立系统**: 专用的新闻处理环境
- **北京时间支持**: 自动时区转换
- **高级评分算法**: 基于机器学习的新闻重要性评分
- **多源数据整合**: 支持 EventRegistry、NewsAPI、Twitter 等
- **实时监控**: 完善的日志记录和性能监控
